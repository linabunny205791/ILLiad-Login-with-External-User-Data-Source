...
<head>
<title>Sign-In | Interlibrary Loan | the Library @ California State University San Marcos</title>
...
<legend><a>Sign-In <span class="openurl_request">to Complete Request</span></a></legend>
<div class="fieldset-wrapper">
<div>Please use your CSUSM email account to login.</div>
<div class="form-line-item">
<label for="txtUsername">username </label><asp:TextBox ID="txtUsername" class="form-text" runat="server" TabIndex="1"></asp:TextBox>
</div>
<div class="form-line-item">
<label for="txtPassword">password </label><asp:TextBox ID="txtPassword" class="form-text" runat="server" TabIndex="2" TextMode="Password"></asp:TextBox>
</div>
<div class="form-line-item" style="margin-top:5px;">
